...
//    if (is_link(LOCK_FILE) && !is_dir(LOCK_FILE)) {
      ...
      if (is_link(LOCK_FILE)) {
          echo(LOCK_FILE." IS a symbolic link\n");
      } else {
          echo(LOCK_FILE." is NOT a symbolic link\n");
      }
      if (!file_exists(LOCK_FILE)) {
          echo(LOCK_FILE." does NOT exist\n");
      } else {
          echo(LOCK_FILE." DOES exist\n");
      }
      if (!is_dir(LOCK_FILE)) {
          echo(LOCK_FILE." is NOT a directory\n");
      } else {
          echo(LOCK_FILE." IS a directory\n");
      }
